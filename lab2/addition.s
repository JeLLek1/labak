...
#zmienne:
# liczba1 - pierwszy składnik sumy
# liczba2 - drugi składnik sumy
# wynik - wynik sumy
#stałe:
...
.section .data
	...
	.equ GREATER, LICZBA2_LEN	#ktora z liczb jest wieksza
liczba1:
	.long 0x75100020, 0x08570030
	.equ LICZBA1_LEN, (. - liczba1)/4
liczba2:
	.long 0x701100FF, 0xE5100020, 0x08570030
...
l2_notaut:
	...
	adcl %ebx, %eax			#dodanie do siebie liczb
	decl %ecx
	movl %eax, wynik(,%ecx,4)	#dodanie kolejnych cyfr wyniku
	pushf				#dodanie do stosu flag
	cmpl $0, %edi			#czy indeks l1 jest 0
	je check_l2
	jmp addition			#jeśli nie to wroc
check_l2:
	cmpl $0, %esi			#czy indeks l2 jest 0
	jne addition			#jesli nie to wroc
	
	call l1_sign
	call l2_sign
	popf
	adcl %ebx, %eax			#ostatnie dodanie dla przepelnienia
	decl %ecx
